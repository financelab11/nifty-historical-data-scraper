...
def fetch_index_data(symbol):
    ...
    try:
        ...
        # Use a more readable name for the DB if needed, but I'll stick to the user's requested names for consistency.
        # User requested: Nifty Next 50, Nifty Midcap 150, Nifty 500, Nifty Smallcap 250, Nifty Microcap 250, Nifty Smallcap 500, Nifty Total Market
        display_names = {
        ...
        df['index_name'] = display_names.get(symbol, symbol)
